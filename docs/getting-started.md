...
- Learn the full [Expression Syntax](./syntax.md)
- Explore [Built-in Functions](./functions.md)
- Create [Custom Functions](./custom-functions.md)
- Compile to [SQL](./sql-compilation.md) or [MongoDB](./mongodb-compilation.md)