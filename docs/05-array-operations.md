...
- [Built-in Functions](./03-functions.md) - Complete function reference
- [Expression Syntax](./02-syntax.md) - Lambda syntax details
- [Custom Functions](./04-custom-functions.md) - Writing array-processing functions
